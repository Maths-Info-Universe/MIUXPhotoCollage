...
/**
 *  The {@code StdDrawExample} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code StdDrawExample.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">StdDrawExample.java</a>
 ...
 *  <pre>
   public class TestStdDraw {
       public static void main(String[] args) {
           StdDrawExample.setPenRadius(0.05);
           StdDrawExample.setPenColor(StdDrawExample.BLUE);
           StdDrawExample.point(0.5, 0.5);
           StdDrawExample.setPenColor(StdDrawExample.MAGENTA);
           StdDrawExample.line(0.2, 0.2, 0.8, 0.2);
       }
   }
  </pre>
 ...
 *  The methods {@code StdDrawExample.line()} and {@code StdDrawExample.point()}
 *  draw lines and points; the methods {@code StdDrawExample.setPenRadius()}
 *  and {@code StdDrawExample.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code StdDrawExample.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  <pre>
   ...
   StdDrawExample.filledPolygon(x, y);
  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code StdDrawExample.setPenRadius(0.025)} makes
 ...
 *  For example, {@code StdDrawExample.setPenColor(StdDrawExample.MAGENTA)} sets the
 ...
 *  For example, {@code StdDrawExample.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code StdDrawExample.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *  <pre>
   ...
   StdDrawExample.setFont(font);
   StdDrawExample.text(0.5, 0.5, "Hello, World");
  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code StdDrawExample.clear(StdDrawExample.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
   StdDrawExample.setScale(-2, +2);
   StdDrawExample.enableDoubleBuffering();

   for (double t = 0.0; true; t += 0.02) {
       double x = Math.sin(t);
       double y = Math.cos(t);
       StdDrawExample.clear();
       StdDrawExample.filledCircle(x, y, 0.05);
       StdDrawExample.filledCircle(-x, -y, 0.05);
       StdDrawExample.show();
       StdDrawExample.pause(20);
   }
  </pre>
 *  <p>
 ...
 *  @author Kevin Wayne
 */
public final class StdDrawExample implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static StdDrawExample std = new StdDrawExample();
    ...
    ***************************************************************************/
     ...
     * {@code StdDrawExample.BLACK}, {@code StdDrawExample.BLUE}, {@code StdDrawExample.CYAN},
     * {@code StdDrawExample.DARK_GRAY}, {@code StdDrawExample.GRAY}, {@code StdDrawExample.GREEN},
     * {@code StdDrawExample.LIGHT_GRAY}, {@code StdDrawExample.MAGENTA}, {@code StdDrawExample.ORANGE},
     * {@code StdDrawExample.PINK}, {@code StdDrawExample.RED}, {@code StdDrawExample.WHITE}, and
     * {@code StdDrawExample.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StdDrawExample)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = StdDrawExample.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(StdDrawExample.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            StdDrawExample.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = StdDrawExample.userX(e.getX());
            mouseY = StdDrawExample.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        StdDrawExample.square(0.2, 0.8, 0.1);
        StdDrawExample.filledSquare(0.8, 0.8, 0.2);
        StdDrawExample.circle(0.8, 0.2, 0.2);

        StdDrawExample.setPenColor(StdDrawExample.BOOK_RED);
        StdDrawExample.setPenRadius(0.02);
        StdDrawExample.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        StdDrawExample.setPenRadius();
        StdDrawExample.setPenColor(StdDrawExample.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        StdDrawExample.filledPolygon(x, y);

        // text
        StdDrawExample.setPenColor(StdDrawExample.BLACK);
        StdDrawExample.text(0.2, 0.5, "black text");
        StdDrawExample.setPenColor(StdDrawExample.WHITE);
        StdDrawExample.text(0.8, 0.8, "white text");
    }
