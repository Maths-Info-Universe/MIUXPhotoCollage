...
public class MIUStyledPanel extends JPanel{
    ...
    protected void paintComponent(Graphics g) {
        if(style == MIUNIVERSE){
            ...
            ImageIcon icon = new ImageIcon(getClass().getResource("/miu/xphotocollage/resources/images/miu.png"));
        ...
        if(style == TITLED_BORDER){
            g.setColor(new Color(238, 238, 238));
            g.fillRect(0, 0, this.getWidth(), this.getHeight());
            g.drawImage((new ImageIcon(getClass().getResource("/miu/xphotocollage/resources/images/arrow.png"))).getImage(), 0, this.getHeight()/2 - 5, 12, 10, this);
            g.drawImage((new ImageIcon(getClass().getResource("/miu/xphotocollage/resources/images/arrow_.png"))).getImage(), this.getWidth() - 12, this.getHeight()/2 - 5, 12, 10, this);
        }
        if(style == SIMPLE){
        ...
        if(style == SIMPLE_CHRISTMAS){
            ...
            if((d.getDayOfMonth() >= 18 && d.getMonthOfYear() == 12) || (d.getDayOfMonth() <= 10 && d.getMonthOfYear() == 1))
                g.drawImage((new ImageIcon(getClass().getResource("/miu/xphotocollage/resources/images/christmas.png"))).getImage(), this.getWidth() - 37, 0, 37, 30, this);
        }
    }
