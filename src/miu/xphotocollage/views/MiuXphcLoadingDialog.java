 ...
 */
public class MiuXphcLoadingDialog extends MIUDialogModel{
    ...
    private MiuXphcIHMController ihmController;
    
    
    public MiuXphcLoadingDialog (MIUConfigManager config, boolean modal, JFrame parent, MiuXphcIHMController ihmController){
    ...
    public void addProcess(String proc) {
        synchronized(this){
            ...
            lab.setIcon(new ImageIcon(getClass().getResource("/miu/xphotocollage/resources/images/loader.gif")));
